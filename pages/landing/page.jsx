      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a
              href="#"
              className="bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium px-5 py-2.5 rounded-full shadow-sm shadow-emerald-500/30 transition-all transform hover:-translate-y-0.5"
            >
              Install on Shopify
            </a>
          </div>
          ...
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex flex-col gap-3">
              <a
                href="#contact"
                onClick={closeMobileMenu}
                className="block text-center px-3 py-2 text-base font-medium text-gray-600 border border-gray-200 rounded-md"
              >
                Contact support
              </a>
              <a
                href="#"
                onClick={closeMobileMenu}
                className="block text-center px-3 py-2 text-base font-medium text-white bg-emerald-500 rounded-md"
              >
                Install on Shopify
              </a>
            </div>
  ...
  return (
    <section className="relative pt-20 pb-32 overflow-hidden gradient-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-6 animate-fade-in-up"
          style={{ animationDelay: "0.1s" }}
        >
          Turn product interest into <br className="hidden sm:block" />{" "}
          <span className="text-emerald-500">saved wishlists</span>
        </h1>

        <p
          className="mt-4 max-w-2xl mx-auto text-lg sm:text-xl text-gray-600 mb-10 animate-fade-in-up"
          style={{ animationDelay: "0.2s" }}
        >
          Give shoppers a fast, customizable way to save products for later
          while gaining insights into the products they want most.
        </p>
        ...
        >
          <a
            href="#"
            className="w-full sm:w-auto px-8 py-3.5 border border-transparent text-base font-medium rounded-full text-white bg-emerald-500 hover:bg-emerald-600 shadow-lg shadow-emerald-500/30 transition-all transform hover:-translate-y-1"
          >
            Install on Shopify
          </a>
          <a
            href="#how-it-works"
            className="w-full sm:w-auto px-8 py-3.5 border border-gray-300 text-base font-medium rounded-full text-slate-900 bg-white hover:bg-gray-50 transition-all shadow-sm"
          >
            See how it works
          </a>
        </div>
        ...
        <p
          className="mt-6 text-sm text-gray-500 font-medium animate-fade-in-up flex items-center justify-center gap-2"
        ...
        >
          <div className="relative rounded-xl shadow-2xl bg-white border border-gray-200 overflow-hidden z-10 mx-auto w-full md:w-11/12 aspect-[16/9] flex flex-col text-left">
            ...
            <div className="bg-gray-100 border-b border-gray-200 px-4 py-3 flex items-center gap-2">
              ...
              <div className="mx-auto bg-white rounded-md text-xs text-gray-400 px-4 py-1 flex items-center gap-2 w-1/2 justify-center border border-gray-200">
                ...
                admin.shopify.com/store/wswishlist
              </div>
            </div>
            ...
            <div className="p-6 bg-gray-50 flex-1 flex flex-col gap-6">
              <div className="flex justify-between items-center">
                ...
                <div className="px-3 py-1 bg-white border border-gray-200 rounded-md text-sm text-gray-600">
                  Last 30 Days
                </div>
              </div>
          ...
          <div className="absolute -right-4 md:-right-12 top-1/4 w-48 md:w-64 bg-white rounded-xl shadow-xl border border-gray-100 p-4 z-20 transform rotate-3 hidden sm:block text-left">
            <div className="flex items-center gap-3 mb-2 border-b border-gray-100 pb-2">
              <div className="w-8 h-8 bg-blue-50 rounded-full flex items-center justify-center text-emerald-500">
                <Heart className="fill-emerald-500 w-4 h-4" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2 mt-3">
              <img
                src="https://placehold.co/40x40/f1f5f9/94a3b8?text=P1"
                alt="Product"
                className="rounded object-cover"
              />
              <img
                src="https://placehold.co/40x40/f1f5f9/94a3b8?text=P2"
                alt="Product"
                className="rounded object-cover"
              />
              <div className="w-10 h-10 bg-gray-50 border border-gray-200 rounded flex items-center justify-center text-xs text-gray-500">
                +3
              </div>
            </div>
          </div>
          ...
          <div className="absolute -left-4 md:-left-12 bottom-1/4 w-48 md:w-64 bg-white rounded-xl shadow-xl border border-gray-100 p-4 z-20 transform -rotate-2 hidden sm:block text-left">
            ...
            <div className="flex items-start gap-3">
              <img
                src="https://placehold.co/50x50/f8fafc/64748b?text=Shoe"
              ...
              <div>
                ...
                <div className="text-xs text-emerald-500 flex items-center gap-1 mt-1">
                  <Flame className="fill-emerald-500 w-3 h-3" /> Added 45 times
                  today
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 flex flex-col items-center text-center transform transition hover:-translate-y-1">
            ...
            <p className="text-gray-600 text-sm">
              Save items instantly without logging in. Syncs smoothly when they
              do.
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 flex flex-col items-center text-center transform transition hover:-translate-y-1">
            ...
            <p className="text-gray-600 text-sm">
              Discover what your shoppers truly desire and optimize your
              inventory.
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 flex flex-col items-center text-center transform transition hover:-translate-y-1">
            ...
            <p className="text-gray-600 text-sm">
              No coding required. Use Shopify app embeds to match your theme
              perfectly.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
            Help shoppers save now and buy when they are ready
          </h2>
          <p className="text-lg text-gray-600">
            Customers often leave without purchasing because they are comparing
            products, waiting for payday, or planning a future purchase. WS
            Wishlist lets them save products instantly and return later without
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">
              Reduce lost product interest
            </h3>
            <p className="text-gray-600">
              Stop relying entirely on immediate add-to-carts. Give hesitant
              buyers a clear action to take instead of bouncing.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              A saved wishlist gives shoppers a concrete reason to return to
              your store when they are ready to complete the purchase.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">
              Understand shopper demand
            </h3>
            <p className="text-gray-600">
              Gain visibility into high-intent products before they are
              purchased, helping you manage stock and marketing efforts.
            </p>
          </div>
        </div>
      </div>
  ...
  const features = [
    {
      ...
      title: "Instant wishlist actions",
      desc: "Products appear in the wishlist immediately while updates sync securely in the background.",
    },
    {
      icon: <UserCircle className="w-5 h-5" />,
      title: "Guest & logged-in",
      desc: "Support shoppers before and after account login seamlessly.",
    },
    {
      icon: <Grid className="w-5 h-5" />,
      title: "Product & collection",
      desc: "Add customizable wishlist hearts to product pages and product cards.",
    },
    {
      icon: <LayoutTemplate className="w-5 h-5" />,
      title: "Header wishlist icon",
      desc: "Place a wishlist icon and item count inside the storefront header.",
    },
    {
      icon: <Sidebar className="w-5 h-5" />,
      title: "Drawer and page",
      desc: "Let shoppers review, remove, share, or move saved products to the cart.",
    },
    {
      icon: <Palette className="w-5 h-5" />,
      title: "Custom design controls",
      desc: "Adjust icon position, colors, text, appearance, and custom CSS.",
    },
    {
      icon: <LineChart className="w-5 h-5" />,
      title: "Top product analytics",
      desc: "See the products shoppers add to wishlists most often.",
    },
    {
      icon: <Store className="w-5 h-5" />,
      title: "Theme-friendly install",
      desc: "Use Shopify app embeds, theme blocks, automatic placement, or Liquid.",
    },
  ];
    ...
    <section id="features" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-emerald-500 font-semibold tracking-wider uppercase text-sm mb-2 block">
            Powerful Features
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
            Everything you need for a perfect wishlist
          </h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300">
            Simple setup designed for modern Shopify themes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <p className="text-gray-400">
              Turn on the WS Wishlist app embed directly from your Shopify theme
              editor.
            </p>
          </div>
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <p className="text-gray-400">
              Customize the heart icon, position, colors, display text, and
              layout to fit your store.
            </p>
          </div>
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">
              Track shopper interest
            </h3>
            <p className="text-gray-400">
              Review recent wishlists and identify the products shoppers save
              most often.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-32">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              A fast, shopper-friendly wishlist experience
            </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-2 border border-gray-100 shadow-sm relative group">
                  ...
                  <div className="aspect-square bg-gray-100 rounded-md mb-3 flex items-center justify-center overflow-hidden">
                    <img
                      src="https://placehold.co/200x200/e2e8f0/64748b?text=Shirt"
                      alt="Product"
                ...
                <div className="bg-white rounded-lg p-2 border border-gray-100 shadow-sm relative group">
                  ...
                  <div className="aspect-square bg-gray-100 rounded-md mb-3 flex items-center justify-center overflow-hidden">
                    <img
                      src="https://placehold.co/200x200/e2e8f0/64748b?text=Pants"
                      alt="Product"
                      className="w-full h-full object-cover"
                    />
                  </div>
              ...
              <div className="absolute top-0 right-0 w-2/3 h-full bg-white shadow-[-10px_0_30px_rgba(0,0,0,0.1)] rounded-r-2xl border-l border-gray-200 flex flex-col p-4 transform translate-x-4 opacity-90">
                ...
                <div className="flex gap-3 mb-4 items-center border-b border-gray-100 pb-4">
                  <div className="w-16 h-16 bg-gray-100 rounded flex-shrink-0">
                    <img
                      src="https://placehold.co/60x60/e2e8f0/64748b?text=Shirt"
                      alt="Product"
                  ...
                  <button className="text-xs bg-slate-900 text-white px-3 py-1.5 rounded font-medium">
                    Add
                  </button>
                </div>
              </div>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 pt-16 border-t border-gray-100">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-10 h-10 border-2 border-emerald-500 bg-emerald-500/10 rounded flex items-center justify-center text-emerald-500 cursor-pointer">
                      <Heart className="w-5 h-5 fill-emerald-500" />
                    </div>
                    <div className="w-10 h-10 border border-gray-200 rounded flex items-center justify-center text-gray-600 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                    <Info className="w-3 h-3 text-gray-500" /> The icon always
                    remains safely positioned inside the product image area.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Designed to fit your storefront
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Your wishlist should look like it belongs to your brand, not an
              invasive third-party widget. Take full control over how and where
...
const Analytics = () => {
  return (
    <section
      id="analytics"
      className="py-24 bg-slate-50 border-y border-gray-200"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
            See what your shoppers want
          </h2>
          <p className="text-lg text-gray-600">
            Review recent wishlists, saved product values, and the products
            receiving the most interest to make data-driven inventory and
            marketing decisions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {[
              {
                ...
                bg: "bg-indigo-50",
                title: "Top 10 saved products",
                desc: "Know your most desired items",
              },
              {
                icon: <Users className="w-6 h-6" />,
                color: "text-emerald-600",
                bg: "bg-emerald-50",
                title: "Recent shopper wishlists",
                desc: "View individual customer intent",
              },
              {
                icon: <DollarSign className="w-6 h-6" />,
                color: "text-blue-600",
                bg: "bg-blue-50",
                title: "Wishlist value overview",
                desc: "Track potential revenue stored",
              },
              {
                ...
                desc: "Compare all-time vs recent data",
              },
            ].map((card, idx) => (
              <div
                key={idx}
              ...
              >
                <div
                  className={`w-12 h-12 ${card.bg} rounded-lg flex items-center justify-center ${card.color}`}
                >
                  {card.icon}
                </div>
                <div>
          ...
          <div className="lg:col-span-2 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden flex flex-col">
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
              ...
              <div className="text-sm bg-white border border-gray-300 px-3 py-1 rounded shadow-sm text-gray-600">
                Export CSV
              </div>
            </div>
    ...
    <section id="pricing" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Start for free, upgrade when you need more capacity. No hidden fees.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
            ...
            <a
              href="#"
              className="block w-full text-center px-6 py-3 border-2 border-emerald-500 text-emerald-500 font-semibold rounded-full hover:bg-emerald-500 hover:text-white transition-colors"
            >
              Start free
            </a>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl flex flex-col relative transform md:-translate-y-4 mt-8 md:mt-0">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              {[
                <span key="1">
                  <strong className="text-white">Unlimited</strong> active
                  wishlists
                </span>,
            ...
            <a
              href="#"
              className="block w-full text-center px-6 py-3 bg-emerald-500 text-white font-semibold rounded-full hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-500/20"
            >
              Choose Growth
            </a>
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          No additional usage charges. Cancel anytime.
        </p>
      </div>
    </section>
  );
...
const FAQ = () => {
  const faqs = [
    {
      q: "Does the app support guest shoppers?",
      a: "Yes. Shoppers can save products without signing in, removing barriers to using the wishlist.",
    },
    {
      q: "Will guest wishlists remain after login?",
      a: "The app can associate and synchronize saved products automatically when the shopper signs into their customer account.",
    },
    {
      q: "Does it work with every Shopify theme?",
      a: "The app supports theme app embeds, app blocks, automatic placement, and a manual Liquid snippet. Some theme-specific styling may require custom CSS, which is supported.",
    },
    {
      q: "Can merchants customize the wishlist design?",
      a: "Yes. Merchants can adjust icon styles, position, colors, text, and add custom CSS to ensure it perfectly matches their brand.",
    },
    {
      q: "Does the app slow down wishlist actions?",
      a: "Wishlist actions update locally first in the browser for immediate visual feedback to the shopper, and synchronize with the server in the background.",
    },
    {
      q: "Is there a free plan?",
      a: "Yes. A Free Forever plan is available for stores with up to 1,000 active wishlists per month.",
    },
    {
      q: "Does the app collect customer contact information?",
      a: "No. The app does not require or collect customer names, email addresses, phone numbers, or physical addresses for standard wishlist functionality.",
    },
  ];
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Start turning shopper interest into future purchases
          </h2>
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Add a fast, customizable wishlist to your Shopify store in minutes.
            Join merchants who are already capturing lost intent.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a
              href="#"
              className="w-full sm:w-auto px-8 py-4 text-lg font-semibold rounded-full text-slate-900 bg-white hover:bg-gray-50 transition-colors shadow-lg"
            >
              Install WS Wishlist
            </a>
            <a
              href="#contact"
              className="w-full sm:w-auto px-8 py-4 text-lg font-semibold rounded-full text-white border border-gray-600 hover:border-gray-400 hover:bg-white/5 transition-colors"
            >
              Contact support
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                The fast, customizable wishlist app built exclusively for modern
                Shopify storefronts.
              </p>
            </div>
